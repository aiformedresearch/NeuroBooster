...
pretrain_base_lr=${pretrain_base_lr:-5e-4} #5e-4 fixed for beit or deit backbone!!
    ...
    for dataset_name in "${datasets[@]}"; do
      for backbone in "${backbones[@]}"; do
        for labels_percentage in "${labels_percentages[@]}"; do
          EXPERIMENT_FOLDER_NAME=../REVISION1/EXPERIMENTS_2025_05_22_1_debugging_vicreg_3/seed${seed}/${dataset_name}/${paradigm}/labels_percentage_${labels_percentage}
          ...
          CUDA_VISIBLE_DEVICES=3 python source/pretraining_deit_vicreg_3.py \
            --paradigm ${paradigm} \
