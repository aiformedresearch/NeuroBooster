    ...
    for dataset_name in "${datasets[@]}"; do
      for backbone in "${backbones[@]}"; do
        for labels_percentage in "${labels_percentages[@]}"; do
          EXPERIMENT_FOLDER_NAME=../REVISION1/EXPERIMENTS_2025_05_22_1_debug_vicreg_4/seed${seed}/${dataset_name}/${paradigm}/labels_percentage_${labels_percentage}
          ...
          CUDA_VISIBLE_DEVICES=0 python source/pretraining_deit_vicreg.py \
            --paradigm ${paradigm} \
