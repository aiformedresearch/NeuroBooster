...
from utils.optim_utils import LARS, adjust_learning_rate, exclude_bias_and_norm, EarlyStopping
...
def get_arguments():
    ...
    parser.add_argument("--paradigm", type=str, default="supervised", help='choices: supervised medbooster vicreg simim')
