...
def plot_multiple_overlays(paths, save_path=None, mode="difference"):
    ...
    # ✅ Add colorbar outside the plot without overlapping
    cbar_ax = fig.add_axes([1.06, 0.1, 0.015, 0.8])  # x=1.06 = safely clear of all plots
...
if __name__ == '__main__':
    input_paths = [
        "/path1//saliency_maps_average",
        "/path2/saliency_maps_average",
        "/path3//saliency_maps_average",
        "/path4/saliency_maps_average",
        "/path5//saliency_maps_average",
        "/path6/saliency_maps_average",
    ]
