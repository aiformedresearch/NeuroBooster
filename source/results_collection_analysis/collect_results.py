...
destination_folder_path = source_folder_path_all_experiments/ f'results_definitive_AGE/' 
...
#               file_path_finetuning = source_folder_path / dataset_name / paradigm / f'labels_percentage_{labels_percentage}'/ f'cl0_{cl0}_cl1_{cl1}'/ f'fold_{k_fold}' / 'finetuning_metrics'/ 'finetuning_df_metrics.csv'
#               file_path_validation = source_folder_path / dataset_name / paradigm / f'labels_percentage_{labels_percentage}'/ f'cl0_{cl0}_cl1_{cl1}'/ f'fold_{k_fold}' / 'val_metrics'/ 'val_df_metrics.csv'
...
# for labels_percentage in labels_percentage_list:        
#     results_collected_AUC[labels_percentage].to_csv(destination_folder_path/ f'results_collected_AUC_seeds_{seeds}_folds_{folds}_labels_percentage_{labels_percentage}_paradigms_{paradigms}.csv')
#     print(f'\nAUC labels percentage {labels_percentage}:\n',results_collected_AUC[labels_percentage])
#     results_collected_PR_AUC[labels_percentage].to_csv(destination_folder_path/ f'results_collected_PR_AUC_seeds_{seeds}_folds_{folds}_labels_percentage_{labels_percentage}_paradigms_{paradigms}.csv')
...
results_collected_RMSE = {labels_percentage: pd.DataFrame(data, index = indexes) for labels_percentage in labels_percentage_list}
