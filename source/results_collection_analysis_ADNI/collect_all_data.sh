...
mkdir -p 'missing_part_supervised_RESULTS_'${original_folder_name};

# Define the directory where you want to start searching
directory=EXPERIMENTS_2023_11_13_ARMAND_thesis_correct/EXPS/seed0/ADNI/supervised

rsync -av --exclude '*batch*' --exclude  '*.png' --exclude  '*.pth' --exclude  '*.npy' $directory 'missing_part_supervised_RESULTS_'${original_folder_name}
