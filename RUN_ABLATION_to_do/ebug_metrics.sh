    ...
    for dataset_name in "${datasets[@]}"; do
      for backbone in "${backbones[@]}"; do
        for labels_percentage in "${labels_percentages[@]}"; do
          EXPERIMENT_FOLDER_NAME=../REVISION1/EXPERIMENTS_ABLATION_2025_07_01_LARS_long_no_augm/seed${seed}/${dataset_name}/${paradigm}/labels_percentage_${labels_percentage}
          ...
          #   CUDA_VISIBLE_DEVICES=2 python source/pretraining_deit_LARS_no_augm.py \
          #     --paradigm ${paradigm} \
          ...
          CUDA_VISIBLE_DEVICES=2 python source/fine_tune_evaluate_deit_debug_metrics.py \
            --paradigm ${paradigm} \
            --images_dir ${images_dir} \
            --tabular_dir ${tabular_dir} \
            --dataset_name ${dataset_name} \
            ...
            --seed ${seed} \
            > ${EXPERIMENT_FOLDER_NAME}/debug_metrics.log 2>&1
