...
pretrain_base_lr=${pretrain_base_lr:-0.005} #5e-4 fixed for beit or deit backbone!!
    ...
    for dataset_name in "${datasets[@]}"; do
      for backbone in "${backbones[@]}"; do
        for labels_percentage in "${labels_percentages[@]}"; do
          EXPERIMENT_FOLDER_NAME=../REVISION1/EXPERIMENTS_ABLATION_2025_06_09_3D_noaugm/seed${seed}/${dataset_name}/${paradigm}/labels_percentage_${labels_percentage}
