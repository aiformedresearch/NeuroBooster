...
EXPERIMENT_FOLDER_NAME=${EXPERIMENT_FOLDER_NAME:-../EXPERIMENT_DEBUG_EXAMPLE_AGE_2025_05_22_1_deit_simim/}
paradigm=${paradigm:-simim} # choices: supervised, medbooster, vicreg, bbworld, simim
