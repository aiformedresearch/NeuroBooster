...
EXPERIMENT_FOLDER_NAME=${EXPERIMENT_FOLDER_NAME:-../EXPERIMENT_DEBUG_EXAMPLE_AGE_2025_05_20_1_long/}
...
# Finetuning
finetune_epochs=${finetune_epochs:-7000}
finetune_min_epochs=${finetune_min_epochs:-5000}
